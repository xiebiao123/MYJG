...
public class EncryptUtil {
	...
	private static final byte[] AES_PASSWORD = "Aes#$%(2015)06".getBytes();
	...
	public static void main(String[] args) throws Exception {
		/*String testStr = "asdfjalskdjf";
		String encodeStr = encrypt(testStr);
		System.out.println(encodeStr);
		System.out.println(decrypt(encodeStr));

		String base64EncodeStr = base64Encode(testStr.getBytes());
		System.out.println(base64EncodeStr);
		System.out.println(new String(base64Decode(base64EncodeStr)));*/

		String name = "西门吹雪";
		String mobie = "13632225566";
		String idcard = "360724199511234032";

		System.out.println(maskName(name));
		System.out.println(maskMobile(mobie));
