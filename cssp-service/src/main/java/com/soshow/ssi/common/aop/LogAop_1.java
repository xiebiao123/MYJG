...
public class LogAop_1 {
	 ...
	 * @param joinPoint
	 */
	@Before("@annotation(com.soshow.ssi.common.annotation.Log)")
	...
	@After("@annotation(com.soshow.ssi.common.annotation.Log)")
	...
	@Around("@annotation(com.soshow.ssi.common.annotation.Log)")
